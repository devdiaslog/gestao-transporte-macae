<x-layouts.app title="Novo Motorista">
    ...
    <div class="mt-4 flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Novo Motorista</h2>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Cadastre um novo motorista no sistema.</p>
        </div>
    </div>

    <div class="mt-6 max-w-2xl">
        <form method="POST" action="{{ route('motoristas.store') }}" class="space-y-6" novalidate>
            @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div class="space-y-1.5">
                            ...
                            <input id="matricula" type="text" name="matricula" value="{{ old('matricula') }}" autofocus
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <div id="contatos-list" class="space-y-3">
                    @forelse(old('contatos', []) as $i => $contato)
    ...
    (function () {
        ...
        var rowIndex  = {{ count(old('contatos', [])) }};
