        ...
        return [
            'id_veiculo' => [
                ...
                function (string $attribute, mixed $value, Closure $fail): void {
                    $aberta = Ocorrencia::where('id_veiculo', $value)
                        ...
                        ->where('id_ocorrencia', '!=', $this->route('ocorrencia')->id_ocorrencia)
                        ->exists();

                    if ($aberta) {
                        $fail('Este veículo já possui outra ocorrência em aberto.');
                    }
                },
            ],
            ...
            'data_hora_inicio' => [
                ...
                function (string $attribute, mixed $value, Closure $fail): void {
                    ...
                    $idAtual = $this->route('ocorrencia')->id_ocorrencia;
