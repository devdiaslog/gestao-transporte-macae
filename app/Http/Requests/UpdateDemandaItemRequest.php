...
class UpdateDemandaItemRequest extends FormRequest
{
        ...
        return [
            'numero_rt' => [
                ...
                Rule::unique('demanda_itens')
                    ->where(fn ($q) => $q
                        ->where('demanda_id', $item->demanda_id)
    ...
    {
        return [
            'numero_rt.unique' => 'Já existe outro item nesta demanda com essa combinação de RT, item e subitem.',
        ];
    }
